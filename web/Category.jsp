...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Categories</h1>
            <a href="AddCategory.jsp" class="btn btn-success mb-3"/>Create New</a>
        <table class="table table-hover table-bordered border-primary">
            ...
            <tbody class="table-group-divider">
                ...
                %>
                <tr style="text-align: center">
                    <td><%=categoryItem.getCategoryID()%></td>
                    <td><%=categoryItem.getCategoryName()%></td>
                    <td><%=categoryItem.getDescription()%></td>
                    <td><a href="UpdateCategory.jsp?txtCategoryID=<%=categoryItem.getCategoryID()%>" class="btn btn-outline-warning">Edit</a> | 
                        <a href="CategoryController?action=delete&txtCategoryID=<%=categoryItem.getCategoryID()%>" class="btn btn-outline-danger">Delete</a></td>
                </tr>
                </div>
                <%
                    }
