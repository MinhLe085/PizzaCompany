...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Pizzas</h1>
            <a href="AddProduct.jsp" class="btn btn-success mb-3"/>Create New</a>
            <table class="table table-hover table-bordered ">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr style="text-align: center">
                        ...
                        <td><a href="UpdateProduct.jsp?id=<%=productItem.getProductID()%>" class="btn btn-outline-warning">Edit</a> |
                            <a href="ProductController?action=view&txtProductID=<%=productItem.getProductID()%>" class="btn btn-outline-primary">Detail</a> |
                            <a href="ProductController?action=delete&txtProductID=<%=productItem.getProductID()%>" class="btn btn-outline-danger">Delete</a></td>
                    </tr>
                    </div>
                    <%
                        }
