 ...
 * @author Minh Le
 */
@WebServlet(name = "SearchByIDController", urlPatterns = {"/SearchByIDController"})
public class SearchByIDController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductItem productItemID = productItemDAO.getProductItemByID(productID);
            if (productItemID != null) {
                request.setAttribute("ProductItemID", productItemID);
            } else {
