...
public class SearchByPriceController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        float unitPrice = Float.parseFloat(request.getParameter("txtPrice"));
        try {
            ProductItemDAO productItemDAO = new ProductItemDAO();
            List<ProductItem> mobiles = productItemDAO.searchPrice(unitPrice);
            request.setAttribute("mobilePrice", mobiles);
