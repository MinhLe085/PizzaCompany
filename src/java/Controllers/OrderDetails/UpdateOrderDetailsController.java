...
@WebServlet(name="UpdateOrderDetailsController", urlPatterns={"/UpdateOrderDetailsController"})
public class UpdateOrderDetailsController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            orderDetailsDAO.updateOrderDetails(new OrderDetails(OrderID, ProductID, UnitPrice, Quantity));
